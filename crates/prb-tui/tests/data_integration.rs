...
fn test_load_json_fixture() {
    ...
    let store = load_events(&fixture, None).expect("Failed to load JSON fixture");
...
fn test_load_multi_transport_json() {
    ...
    let store = load_events(&fixture, None).expect("Failed to load multi-transport JSON");
...
fn test_load_empty_json() {
    ...
    let store = load_events(&fixture, None).expect("Failed to load empty JSON");
...
fn test_event_store_filter() {
    ...
    let fixture = fixtures_dir().join("multi_transport.json");
    let store = load_events(&fixture, None).expect("Failed to load fixture");
...
fn test_load_pcap_basic() {
    ...
    // Load the PCAP file
    let store = load_events(&pcap_path, None).expect("Failed to load PCAP");
...
fn test_load_mcap_roundtrip() {
    ...
    let store = load_events(&mcap_path, None).expect("Failed to load MCAP");
...
fn test_format_detection() {
    ...
    let store = load_events(&json_path, None).expect("Failed to load JSON");
